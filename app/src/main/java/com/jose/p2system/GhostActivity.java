...
public class GhostActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (id){
            case R.id.nav_home:
                ...
                Intent intent = new Intent(GhostActivity.this, MainActivity.class);
                startActivity(intent);
