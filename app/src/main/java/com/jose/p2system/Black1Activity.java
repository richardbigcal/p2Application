...
public class Black1Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (id){
            case R.id.nav_home:
                ...
                Intent intent = new Intent(Black1Activity.this, MainActivity.class);
                startActivity(intent);
