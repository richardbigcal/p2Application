...
public class DelroActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (id){
            case R.id.nav_home:
                ...
                Intent intent = new Intent(DelroActivity.this, MainActivity.class);
                startActivity(intent);
